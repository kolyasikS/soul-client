                ...
                <div className={styles.profile__right_block}>
                    <div className={styles.profile__info_blocks_wrapper}>
                        <div className={styles.profile__info_block}>
                            <p className={styles.profile__info_item}><span>Ім'я:</span> {user.name}</p>
                            <p className={styles.profile__info_item}><span>Прізвище:</span> {user.surname}</p>
                        </div>
                        <div className={styles.profile__info_block}>
                            <p className={styles.profile__info_item}><span>Нація:</span> {user.nation}</p>
                            <p className={styles.profile__info_item}><span>День народження:</span> {convertDateToString(user.birthday)}</p>
                        </div>
                    </div>
                    <Club clubId={user.clubId}/>
                    <p className={styles.profile__info_description_title}>Опис</p>
