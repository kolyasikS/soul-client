            ...
            <form className={styles.form}>
                <div className={styles.form__block}>
                    <ClassicInput
                        ...
                        setValue={setName}
                    >Назва</ClassicInput>
                    {errors.name && <ValidationError className={styles.form__block_error}>некоректне значення</ValidationError>}
                </div>
                <div className={styles.form__block}>
                    ...
                    {errors.date && <ValidationError className={styles.form__block_error}>некоректне значення</ValidationError>}
                </div>
                <ClassicTextArea
                    value={description}
                ...
                <div className={'flex gap-3'}>
                    <ClassicButton onClick={cancel} variant={'danger'}>Відминити</ClassicButton>
                    <ClassicButton onClick={apply}>Створити</ClassicButton>
                </div>
            </form>
        </ClassicDialog>
    );
