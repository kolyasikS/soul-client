...
const matters = [
    'Для інцидентів безпеки.',
    'Якщо у вас є проблеми чи скарги щодо якості послуг, виставлення рахунків, виставлення рахунків або сумніви щодо нашої політики.',
    'Для будь-яких скарг (наприклад, пов’язаних із екологічним законодавством, правами людини чи екологічним законодавством).',
    ...
    return (
        <section className={styles.contacts}>
            <div className={styles.contacts__title_wrapper}>
                <h1 className={styles.contacts__title}>Зв'язатися з нами</h1>
            </div>
            <div>
                <h4 className={styles.contacts__matters_title}>Можливо, вам знадобиться зв’язатися з нами для наступних питань:</h4>
            ...
            <div className={styles.contacts__form_title}>
                <h2>Давайте поговоримо про вашу проблему</h2>
                <p>Напишіть нам через форму нижче, і ми зв’яжемося з вами</p>
            </div>
           <Form/>
        </section>
    );
