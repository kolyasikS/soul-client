    ...
    return (
        <ClassicDialog zIndex={22} onClick={close}>
            <div className={styles.dialog}>
                <h1 className={styles.letter__title}>Письмо</h1>
                ...
                <div className={styles.dialog__features}>
                    <div>
                        <ClassicButton onClick={close}>Закрити</ClassicButton>
                    </div>
                    <div className={styles.dialog__choices}>
                        <ClassicButton onClick={accept}>Прийняти</ClassicButton>
                        <DangerButton onClick={reject}>Відмовити</DangerButton>
                    </div>
                </div>
            </div>
        </ClassicDialog>
